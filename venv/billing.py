...
class BillingManager:
    ...
    def create_bill_table(self):
        ...
        self.tree_frame.grid(row=1, column=1, padx=20, pady=20, sticky="se")
    ...
    def create_calculator(self):
        ...
        self.calc_frame.grid(row=1, column=0, padx=20, pady=20, sticky="sw")
    ...
    def show_invoice_window(self, customer_name, customer_contact, invoice_id, company_name):
        ...
        tk.Label(details_frame, text=f"Company: {company_name}", font=("Arial", 10), anchor="w").pack(fill=tk.X)
